...
const Colection = Loadable(lazy(() => import("app/views/dashboard/money")));
const Brand = Loadable(lazy(() => import("app/views/dashboard/role")));
...
const routes = [
  {
    ...
    children: [
      ...
      { path: "/dashboard/role", element: <Brand /> },
